...
async function runMigrations() {
    try {
        ...
        await connection.query(`
            ...
            (2, 'assets', 'assets.view', 'Geräte verwalten', '<p>Hier kannst du neue Geräte anlegen, bearbeiten und deren Status ändern. Achte darauf, dass jedes Gerät eine eindeutige Inventarnummer hat.</p>', 1),
