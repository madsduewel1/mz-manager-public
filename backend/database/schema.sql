...
CREATE TABLE IF NOT EXISTS accessories (
    ...
    inventory_number VARCHAR(100) UNIQUE NULL,
...
CREATE TABLE IF NOT EXISTS lendings (
    ...
    CHECK (asset_id IS NOT NULL OR container_id IS NOT NULL OR accessory_id IS NOT NULL)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
('org_name', 'MZ-MANAGER'),
('module_accessories_enabled', 'true'),
