...
function QRScanner({ isOpen, onClose, onScanSuccess }) {
    ...
    const handleScanSuccess = (decodedText) => {
        ...
        try {
            // Try to parse it as a URL and get the last path segment
            const url = new URL(decodedText);
            const pathSegments = url.pathname.split('/');
            qrCode = pathSegments.pop() || pathSegments.pop(); // Handle trailing slashes
        } catch (e) {
            // Not a valid URL, assume the decoded text is the QR code itself.
            // This is the expected behavior for codes like "ASSET-xxxx"
        }
