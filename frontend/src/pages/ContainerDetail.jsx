                        ...
                        <div>
                            ...
                            {container.assets && container.assets.length > 0 ? (
                                <div className="grid-compact mt-md">
                                    {[...container.assets].sort((a, b) => a.inventory_number.localeCompare(b.inventory_number, undefined, { numeric: true, sensitivity: 'base' })).map((asset) => (
                                        <Link to={`/assets/${asset.inventory_number}`} key={asset.id} className="card p-md" style={{ textDecoration: 'none' }}>
